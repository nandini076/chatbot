...
    toggler: {
        found: !!chatbotToggler,
        classes: chatbotToggler?.classList?.toString() || 'N/A',
        children: chatbotToggler?.children?.length || 0
    },
    closeBtn: {
        found: !!closeBtn,
        classes: closeBtn?.classList?.toString() || 'N/A'
    },
    input: {
        found: !!chatInput,
        placeholder: chatInput?.placeholder || 'N/A'
    },
    sendBtn: {
        found: !!sendChatbtn,
        classes: sendChatbtn?.classList?.toString() || 'N/A'
    },
    chatbox: {
        found: !!chatbox,
        children: chatbox?.children?.length || 0
    }
});
...
  console.log("Initializing chat controls...");
...
    });
    console.log("Chat toggler listener added ✅");
  } else {
